            ...
            addAll(
                listOf(
                    Theory(
                        ...
                        content = "В Kotlin переменные объявляются с помощью 'var' (изменяемые) и 'val' (неизменяемые, константы). " +
                                "Пример: var x = 5; x = 10 — допустимо, но val y = 5; y = 10 — вызовет ошибку. " +
                                "'val' поддерживает инкапсуляцию в ООП, обеспечивая неизменяемость состояния объекта. " +
                                "Типы данных могут быть указаны явно (val name: String) или выведены автоматически.",
                        category = "Основы"
                    ),
                    Theory(
                    ...
                    Theory(
                        title = "Циклы",
                        content = "'for' используется для итерации по диапазонам или коллекциям. " +
                                "Пример: for (i in 1..3) { println(i) }. В ООП удобно для обработки свойств объекта.",
                        category = "Циклы"
                    ),
                    Theory(
            ...
            addAll(
                listOf(
                    ...
                    Theory(
                        ...
                        category = "Управление корутинами"
                    ),
                    Theory(
            ...
            addAll(
                listOf(
                    ...
                    Theory(
                        ...
                        category = "Операции с коллекциями"
                    ),
                    Theory(
                    ...
                    Theory(
                        ...
                        category = "Преобразование коллекций"
                    ),
                    Theory(
